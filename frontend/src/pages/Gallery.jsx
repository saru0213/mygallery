...
import { ArrowLeft, X, Image, Trash2, CheckCircle, AlertTriangle, Calendar, HardDrive, FileType } from 'lucide-react';
...
function GalleryPage() {
    ...
    const handleDeleteImage = async (imageId) => {
        try {
            ...
            const url = `http://localhost:5000/api/images/${imageId}`;
            const result = await fetch(url, {
                method: 'DELETE'
            });
            ...
            <div className="max-w-7xl mx-auto">
                ...
                <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 mb-8">
                    <div className="text-center sm:text-left">
                        ...
                        <p className="text-gray-600">Browse and manage your image collection</p>
                    </div>
                    ...
                    <div className="flex gap-3">
                        ...
                        <button
                            ...
                            className="flex items-center gap-2 px-4 py-2.5 bg-blue-500 hover:bg-blue-600 text-white rounded-xl shadow-sm transition-colors"
                        >
